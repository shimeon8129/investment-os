...
# Groq API wrapper for narrative scoring (free tier)
# =========================================================
...
def call_groq_narrative(tickers_with_names: list[dict], perspective: str = "主流") -> list[dict]:
    """
    Call Groq API to score narrative strength for given tickers.
