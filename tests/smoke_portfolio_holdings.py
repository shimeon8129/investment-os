...
def main():
    ...
    assert get_holding_shares("00992A") == 0
    assert get_holding_shares("2308") == 20
    assert get_holding_shares("2330") == 30
    assert get_holding_shares("2345") == 65
    assert get_holding_shares("2408") == 120
    assert get_holding_shares("3711") == 50
    assert get_holding_shares("6830") == 70
